...
<div id="analyticspro-app"
    ...
    <div id="analyticspro-map-shell" class="analyticspro-map-shell">
        ...
        <div id="cadastral-opacity-control" class="d-none analyticspro-cadastral-opacity-control" aria-live="polite">
            <div class="analyticspro-cadastral-opacity-control-inner d-flex align-items-center gap-2">
