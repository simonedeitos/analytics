...
ob_start();
?>
<div class="analyticspro-map-toolbar d-flex align-items-center justify-content-end gap-2 flex-wrap w-100">
    <?php if (analyticspro_is_admin()): ?>
        <form method="get" class="d-flex align-items-center gap-2 mb-0">
            <label class="form-label mb-0 small text-muted" for="analyticspro-admin-tenant-select">Vista admin</label>
...
analyticspro_render_header('Mappa marker', [
    'app_assets' => true,
    'body_class' => 'map-page',
